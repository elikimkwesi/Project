  ...
  static List<Disease> generateDiseases() {
    return [
      Disease(
        ...
        detailPage: CornCommonRust(title: '',),
      ),
      Disease(
        name: 'Corn Gray Leaf',
        imagePath: 'assets/corngray.jpeg',
        readTime: '5 mins read',
        detailPage: CornGrayLeaf(title: '',),
      ),
      Disease(
        name: 'Northern Corn Leaf Blight',
        imagePath: 'assets/ncorn.JPG',
        readTime: '5 mins read',
        detailPage: NorthernCornLeafBlight(title: '',),
      ),
      Disease(
        name: 'Orange Citrus Greening',
        imagePath: 'assets/orange.jpg',
        readTime: '5 mins read',
        detailPage: OrangeCitrus(title: '',),
      ),
      Disease(
        name: 'Pepper Bacterial Spot',
        imagePath: 'assets/pepper1.jpg',
        readTime: '5 mins read',
        detailPage: PepperBacterialSpot(title: '',),
      ),
      Disease(
        name: 'Potato Early Blight',
        imagePath: 'assets/16.jpg',
        readTime: '5 mins read',
        detailPage: PotatoEarlyBlight(title: '',),
      ),
      Disease(
        name: 'Potato Late Blight',
        imagePath: 'assets/plate.jpg',
        readTime: '5 mins read',
        detailPage: PotatoLateBlight(title: '',),
      ),
      Disease(
      ...
      Disease(
        ...
        readTime: '5 mins read',
        detailPage: TomatoSpider(title: '',),
      ),
      Disease(
        name: 'Tomato Target spot',
        imagePath: 'assets/target2.jpg',
        readTime: '5 mins read',
        detailPage: TomatoTarget(title: '',),
      ),
      Disease(
        name: 'Tomato Yellow Leaf Curl Virus',
        imagePath: 'assets/curl.png',
        readTime: '5 mins read',
        detailPage: TomatoYellow(title: '',),
      ),
      Disease(
        name: 'Tomato Mosaic Virus ',
        imagePath: 'assets/mosaic2.jpg',
        readTime: '5 mins read',
        detailPage: TomatoMosaic(title: '',),
      ),
    ];
  }
}
